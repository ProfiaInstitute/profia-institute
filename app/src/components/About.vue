  ...
  <section class="max-w-7xl mx-auto">
    <div class="max-w-5xl mx-auto">
      ...
      <div class="space-y-24 pt-4">
        ...
        <div class="border-[2px] border-red-800 relative p-8 bg-gray-200 rounded-lg shadow-lg lg:mr-48">
          <div
            class="absolute -top-8 right-5 bg-orange-500 px-8 py-4 rounded-md shadow-sm"
          >
